import { WithdrawYearStatusFailed, WithdrawYearStatusSuccess } from "@/types/model"
...
export default function TotalCardWithdrawDetail({ loadingMonthStatusSuccess, currentMonthSuccess, previousMonthSuccess, monthPercentageSuccessChange, loadingYearStatusSuccess,
    currentYearSuccess,
    ...
    previousYearSuccessData: WithdrawYearStatusSuccess,
    ...
    previousYearFailedData: WithdrawYearStatusFailed,
