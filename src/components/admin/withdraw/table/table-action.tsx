...
import { TableActionWithdrawProps } from "@/types/table";
import useModalWithdraw from "@/store/withdraw/modal";

const TableActionWithdraw = ({ withdraw }: TableActionWithdrawProps) => {
  const { showModalEdit, showModalDelete } = useModalWithdraw();
