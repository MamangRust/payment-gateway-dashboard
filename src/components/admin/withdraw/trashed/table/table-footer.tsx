...
import { TableFooterWithdrawTrashedProps } from "@/types/table/withdraw";

const TableFooterWithdrawTrashed = ({
  table,
  pagination,
  onPageChange,
  onPageSizeChange,
}: TableFooterWithdrawTrashedProps) => {
...
export default TableFooterWithdrawTrashed;
