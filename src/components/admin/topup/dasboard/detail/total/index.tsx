import { TopupYearStatusFailed, TopupYearStatusSuccess } from "@/types/model"
...
export default function TotalCardTopupDetail({ loadingMonthStatusSuccess, currentMonthSuccess, previousMonthSuccess, monthPercentageSuccessChange, loadingYearStatusSuccess,
    currentYearSuccess,
