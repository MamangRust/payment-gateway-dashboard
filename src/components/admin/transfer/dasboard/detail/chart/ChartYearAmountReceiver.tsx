...
export default function ChartYearAmountReceiver({ loadingYearTransferAmountReceiver, yearlyAmount }: { loadingYearTransferAmountReceiver: boolean, yearlyAmount: any }) {
    return (
        <>
