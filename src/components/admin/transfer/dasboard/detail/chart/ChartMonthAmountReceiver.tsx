...
export default function ChartMonthAmountReceiver({ loadingMonthTransferAmountReceiver, monthlyAmount }: { loadingMonthTransferAmountReceiver: boolean, monthlyAmount: any }) {
    return (
        <>
