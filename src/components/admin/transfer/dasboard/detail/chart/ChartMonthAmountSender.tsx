...
export default function ChartMonthAmountSender({ loadingMonthTransferAmountSender, monthlyAmount }: { loadingMonthTransferAmountSender: boolean, monthlyAmount: any }) {
    return (
        <>
