...
import { TableFooterTransferTrashedProps } from "@/types/table";

const TableFooterTransferTrashed = ({
  table,
  pagination,
  onPageChange,
  onPageSizeChange,
}: TableFooterTransferTrashedProps) => {
...
export default TableFooterTransferTrashed;
