...
import { TableFooterTransactionTrashedProps } from "@/types/table";

const TableFooterTransactionTrashed = ({
  table,
  pagination,
  onPageChange,
  onPageSizeChange,
}: TableFooterTransactionTrashedProps) => {
...
export default TableFooterTransactionTrashed;
