...
export default function TotalCardTransactionDetail({ loadingMonthStatusSuccess, currentMonthSuccess, previousMonthSuccess, monthPercentageSuccessChange, loadingYearStatusSuccess,
    currentYearSuccess,
