...
export default function ChartMonthPaymentMethod({ loadingMonthTransactionMethod, monthlyPaymentMethod }: { loadingMonthTransactionMethod: boolean, monthlyPaymentMethod: any }) {
    return (
        <>
