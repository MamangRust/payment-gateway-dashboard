...
export default function ChartMonthPaymentMethod({ loadingMonthPaymentMethod, monthlyPaymentMethod }: { loadingMonthPaymentMethod: boolean, monthlyPaymentMethod: any }) {
    return (
        <>
