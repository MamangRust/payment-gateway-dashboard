...
export default function ChartYearPaymentMethodDetail({ loadingYearPaymentMethod, yearlyPaymentMethod }: { loadingYearPaymentMethod: boolean, yearlyPaymentMethod: any }) {
    return (
        <>
