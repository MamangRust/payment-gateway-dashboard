...
export default function ChartYearPaymentMethodApiKey({ loadingYearPaymentMethod, yearlyPaymentMethod }: { loadingYearPaymentMethod: boolean, yearlyPaymentMethod: any }) {
    return (
        <>
                ...
                <Card className="w-full shadow-lg rounded-md border">
                    ...
                    <CardContent>
                        <ThemeChart
                            options={{
                                chart: {
                                    id: "yearly-payment-method-chart",
                                    toolbar: { show: false },
                                },
                                xaxis: {
