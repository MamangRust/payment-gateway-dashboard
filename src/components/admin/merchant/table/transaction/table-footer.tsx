...
import { TableFooterMerchantTransactionProps } from "@/types/table";

const TableFooterMerchantTransaction = ({
  table,
  pagination,
  onPageChange,
  onPageSizeChange,
}: TableFooterMerchantTransactionProps) => {
...
export default TableFooterMerchantTransaction;
