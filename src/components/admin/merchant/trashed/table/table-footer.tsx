...
import { TableFooterMerchantTrashedProps } from "@/types/table";

const TableFooterMerchantTrashed = ({
  table,
  pagination,
  onPageChange,
  onPageSizeChange,
}: TableFooterMerchantTrashedProps) => {
...
export default TableFooterMerchantTrashed;
