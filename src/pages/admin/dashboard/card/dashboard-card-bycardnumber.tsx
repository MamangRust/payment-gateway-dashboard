  ...
  const fetchYearlyData = useCallback(
    async (year: number) => {
      try {
        ...
        await findYearlyBalanceByCard(toast, year, card_number as string);
      } catch (error) {
  ...
  const fetchMonthlyWithdraws = useCallback(
    async (year: number) => {
      try {
        ...
        await findMonthlyWithdrawAmountByCard(
          toast,
          year,
  ...
  const fetchYearlyWithdraws = useCallback(
    async (year: number) => {
      try {
        ...
        await findYearlyWithdrawAmountByCard(
          toast,
          year,
          card_number as string,
        );
  ...
  const fetchYearlyTopups = useCallback(
    async (year: number) => {
      try {
        ...
        await findYearlyTopupAmountByCard(toast, year, card_number as string);
      } catch (error) {
  ...
  const fetchYearlyTransactions = useCallback(
    async (year: number) => {
      try {
        ...
        await findYearlyTransactionAmountByCard(
          toast,
          year,
          card_number as string,
        );
  ...
  const fetchMonthlyTransfersSender = useCallback(
    async (year: number) => {
      try {
        ...
        await findMonthlyTransferSenderAmountByCard(
          toast,
          year,
          card_number as string,
        );
  ...
  const fetchYearlyTransfersSender = useCallback(
    async (year: number) => {
      try {
        ...
        await findYearlyTransferSenderAmountByCard(
          toast,
          year,
          card_number as string,
        );
  ...
  const fetchMonthlyTransfersReceiver = useCallback(
    async (year: number) => {
      try {
        ...
        await findMonthlyTransferReceiverAmountByCard(
          toast,
          year,
          card_number as string,
        );
  ...
  const fetchYearlyTransfersReceiver = useCallback(
    async (year: number) => {
      try {
        ...
        await findYearlyTransferReceiverAmountByCard(
          toast,
          year,
          card_number as string,
        );
